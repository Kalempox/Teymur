    ...
    items: [
      { id: "rooms",    side: "left",  href: "#",           labelTr: "Odalar",     labelEn: "Rooms",    labelAr: "الغرف",
        dropdown: { headingTr: "Odalar & Süitler", headingEn: "Rooms & Suites", headingAr: "الغرف والأجنحة", descTr: "Gaziantep'in kalbinde, her konforu düşünülerek tasarlanmış oda ve süitlerimizi keşfedin.", descEn: "Discover our thoughtfully designed rooms and suites.", descAr: "اكتشف غرفنا وأجنحتنا المصممة بعناية.", viewAllTr: "Tüm Odaları Gör", viewAllEn: "View All Rooms", viewAllAr: "عرض جميع الغرف", viewAllHref: "/odalar",
          photos: [
            { src: BASE_ROOM + "1.jpg",  labelTr: "Standart French Oda", labelEn: "Standard French Room", labelAr: "غرفة فرنسية قياسية", href: "/odalar/standart-french-oda" },
            { src: BASE_ROOM + "14.jpg", labelTr: "Standart Twin Bed",   labelEn: "Standard Twin Bed",   labelAr: "غرفة توأم",              href: "/odalar/standart-twin-bed-oda" },
            { src: BASE_ROOM + "15.jpg", labelTr: "Standart Triple Oda", labelEn: "Standard Triple Room", labelAr: "غرفة ثلاثية",           href: "/odalar/standart-triple-oda" },
            { src: BASE_ROOM + "11.jpg", labelTr: "Aile Süiti",        labelEn: "Family Suite",         labelAr: "جناح عائلي",            href: "/odalar/aile-suiti" },
            { src: BASE_ROOM + "16.jpg", labelTr: "Kral Süit",         labelEn: "King Suite",           labelAr: "جناح كينج",             href: "/odalar/kral-suit" },
            { src: BASE_ROOM + "12.jpg", labelTr: "Engelsiz Oda",      labelEn: "Accessible Room",      labelAr: "غرفة ذوي الاحتياجات",   href: "/odalar/engelsiz-oda" },
          ],
        },
      },
