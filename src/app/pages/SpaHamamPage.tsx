...
// ── Staggered mosaic: 2 flex-columns, align-items:center → right col auto-offset
function Mosaic({ cols }: {
  cols: { imgs: { src: string; h: number }[] }[]
}) {
  return (
...
// ── Hero Slider ────────────────────────────────────────────────────────────────
function HeroSlider() {
  const { spa } = useContent();
  const HERO_IMGS = spa.heroImgs;
  ...
  return (
    <section style={{ position: "relative", height: "100vh", overflow: "clip", background: "#0a0705" }}>
      {HERO_IMGS.map((src, i) => (
        <img key={i} src={src} alt="Spa & Hamam" style={{
...
// ── Page ──────────────────────────────────────────────────────────────────────
export function SpaHamamPage() {
  useReveal();
  const { spa } = useContent();
  const s0 = spa.sections[0] ?? { label: "Spa", title: "", desc: "", hours: "", imgs: [] };
  const s1 = spa.sections[1] ?? { label: "", title: "", desc: "", hours: "", imgs: [] };
  const s2 = spa.sections[2] ?? { label: "", title: "", desc: "", hours: "", imgs: [] };
  ...
  return (
    <div style={{ background: CREAM, fontFamily: "Inter, sans-serif" }}>
      ...
      {/* ══ SECTION 1 — cream, text left / 5-img mosaic right ══ */}
        ...
        <div style={{
          ...
          <div style={{ position: "sticky", top: "120px" }}>
            ...
            <h2 data-reveal data-delay="100" style={{
              ...
              margin: "0 0 24px", lineHeight: 1.12,
              textTransform: "uppercase",
            }}>
              {s0.title}
            </h2>
            ...
            <div data-reveal data-delay="200" style={{ display: "flex", gap: "12px", flexWrap: "wrap", marginBottom: "40px" }}>
              <BtnGold to="/iletisim" label="SPA MENÜSÜ" />
            </div>

            {/* Hours */}
            <div data-reveal data-delay="250" style={{ marginTop: "8px" }}>
              <div style={{
              ...
              <div style={{ fontSize: "14px", color: DARK, marginBottom: "2px" }}>
                Pzt – Paz
              </div>
              <div style={{ fontSize: "14px", color: GOLD, fontWeight: 500 }}>
                07:00 – 22:00
              </div>
            </div>
          </div>

          {/* Right: 5-image staggered mosaic */}
          <Mosaic cols={[
            { imgs: [
      ...
      {/* ══ SECTION 2 — dark, 3-img mosaic left / text right ══ */}
      <section className="spa-section" style={{ background: NAVY, padding: "100px 64px 64px" }}>
        <div style={{
          display: "grid",
      ...
      {/* ══ SECTION 3 — cream, text left / 2-img mosaic right ══ */}
      <section className="spa-section" style={{ background: CREAM, padding: "100px 64px 64px" }}>
        <div style={{
          display: "grid",
          gridTemplateColumns: "4fr 8fr",
          ...
          <div style={{ position: "sticky", top: "120px", paddingLeft: "40px" }} className="spa-no-indent">
            ...
            <p data-reveal data-delay="150" style={{
              ...
              Geleneksel kese ile derin gözenek temizliği ve cilt yenilenmesi. Doğal malzemelerle hazırlanan peeling karışımlarımız cildinizi yumuşatır, parlaklık ve tazelik kazandırır. Her tedavi uzman terapistlerimiz tarafından kişisel ihtiyaçlarınıza göre uygulanır.
            </p>
          </div>
          ...
          <Mosaic cols={[
            { imgs: [
              { src: ORIG + "2.jpg", h: 380 },
            ]},
            { imgs: [
              { src: ORIG + "4.jpg", h: 500 },
            ]},
          ]} />
        </div>
      </section>

      {/* ══ SECTION 4 — dark, 2-img mosaic left / text right ══ */}
      <section className="spa-section" style={{ background: NAVY, padding: "100px 64px 64px" }}>
        <div style={{
          display: "grid",
          gridTemplateColumns: "8fr 4fr",
          ...
          <Mosaic cols={[
            { imgs: [
              { src: ORIG + "6.jpg", h: 500 },
            ]},
            { imgs: [
              { src: ORIG + "11.jpg", h: 340 },
            ]},
          ]} />
          ...
          <div className="spa-text-col spa-no-indent" style={{ position: "sticky", top: "120px", paddingRight: "40px" }}>
            ...
            <h2 data-reveal data-delay="100" style={{
              ...
              Aromaterapi<br />& Masaj
            </h2>
            <p data-reveal data-delay="150" style={{
              fontSize: "14px", lineHeight: 1.85,
              color: MID, margin: "0 0 40px",
            }}>
              Uzakdoğu masaj teknikleri ve doğal aromaterapi yağlarıyla özenle uygulanan tedavilerimiz beden ve zihnin tam dinginliğe kavuşmasını sağlar. Her seans kişisel ihtiyaçlarınıza göre düzenlenerek benzersiz bir deneyim sunar.
            </p>
          </div>
        </div>
      </section>
      ...
      <style>{`
        ...
        @media (max-width: 640px) {
          /* Section padding'i kaldır — Mosaic tam genişlik için */
          ...
          /* Ters sıralı grid'lerde: metin önce, görsel sonra */
          ...
          /* Mosaic → yatay scroll-snap carousel */
          .spa-mosaic {
